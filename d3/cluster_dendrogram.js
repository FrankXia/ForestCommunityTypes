...
require([
    ...
    var conUSGroupServiceUrl = "http://184.72.55.235:6080/arcgis/rest/services/FIA_Atlas/CONUS_ForestGroupsWeb/ImageServer";
    var alaskaGroupServiceUrl = "http://184.72.55.235:6080/arcgis/rest/services/FIA_Atlas/Alaska_ForestGroups/ImageServer";

    var conUSSpeciesServiceUrl = "http://184.72.55.235:6080/arcgis/rest/services/FOREST_TYPES/conus_foresttypeALB/ImageServer";
    var alaskaSpeciesServiceUrl = "http://184.72.55.235:6080/arcgis/rest/services/FOREST_TYPES/Alaska_ForestTypesALB/ImageServer";
    ...
    dojo.connect(legendButton, "onClick", function(evt) {
        ...
        if(legendDijit) {
            ...
            legendDescPane = new FloatingPane({
                ...
                dockable: false,
                closable: true,
                style: "position:absolute;left:4px;bottom:140px;width:420px;height:600px;z-Index:999;background-color: #1e4004;",
                id: "legendPane"
    ...
    dojo.connect(descButton, "onClick", function(evt) {
        ...
        if(descDijit) {
            ...
            descriptionPane = new FloatingPane({
                ...
                dockable: false,
                closable: true,
                style: "position:absolute;left:4px;bottom:140px;width:500px;height:536px;z-Index:999;",
